...
const CIRCLES = [
  {
    ...
    privatePosts: [
      { id: 'sf1', author: '好创意笔冢', title: '【碑帖考】颜体多宝塔碑的藏锋技巧与动力学分析', views: '2340', likes: '1.2万', image: 'https://images.unsplash.com/photo-1764696505036-9a0c7048c630?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
      ...
      { id: 'sf6', author: '好创意长安', title: '宣纸品鉴：泾县生宣在不同墨墨比下的晕墨曲线', views: '1500', likes: '3.2k', image: 'https://images.unsplash.com/photo-1748563223560-42d7a0828961?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8JUU1JUFFJUEzJUU3JUJBJUI4fGVufDB8fDB8fHww' },
      ...
      { id: 'sf10', author: '好创意笔冢', title: '米芾《蜀素帖》结体密码：如何处理重心的微妙偏移', views: '1100', likes: '3.8k', image: 'https://images.unsplash.com/photo-1633580969752-a821ac729fce?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fCVFNSVBRCU5NyVFNSVCOCU5NnxlbnwwfHwwfHx8MA%3D%3D' },
      ...
      { id: 'sf16', author: '好创意长安', title: '如何养护紫毫笔：关于脱脂与清洗的终极指南', views: '1300', likes: '3.4k', image: 'https://images.unsplash.com/photo-1603479354350-7391f7421afd?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YnJ1c2h8ZW58MHx8MHx8fDA%3D' },
      ...
      { id: 'sf20', author: '好创意笔冢', title: '草书临帖指南：张旭《古诗四帖》的连绵笔势重构', views: '3800', likes: '1.4万', image: 'https://images.unsplash.com/photo-1734941133462-25095e2f80e3?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fCVFOCU4RCU4OSVFNCVCOSVBNnxlbnwwfHwwfHx8MA%3D%3D' }
    ]
  },
  {
    id: 'anime-research',
    ...
    founder: '晓雨动漫社 传承',
    heroTitle: '羁绊，追番，同人。\n守护你的热爱。',
    lore: '前身为好创意学院“晓雨动漫社”。这里没有偏见与引战，只有对纸片人最纯粹的爱。',
    quiz: [
    ...
    privatePosts: [
      ...
      { id: 'ar3', author: '好创意吃谷人', title: '痛层陈列学：亚克力砖与吧唧在自然光下的折射收纳法', views: '3400', likes: '1.2万', image: 'https://plus.unsplash.com/premium_photo-1739027969843-036e37e77414?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fCVFNSU4RCVBMSVFOSU4MCU5QXxlbnwwfHwwfHx8MA%3D%3D' },
      ...
      { id: 'ar6', author: '好创意画师', title: '同人插画进阶：环境光与反射光在二次元厚涂中的计算', views: '6100', likes: '2.9万', image: 'https://images.unsplash.com/photo-1578088854867-b54b766b9dc4?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fCVFNSU4RCVBMSVFOSU4MCU5QXxlbnwwfHwwfHx8MA%3D%3D' },
      ...
      { id: 'ar12', author: '好创意吃谷人', title: '日拍切煤指南：如何避开Mercari的高溢价与瑕疵雷区', views: '3100', likes: '1.1万', image: 'https://images.unsplash.com/photo-1580477667995-15608051dc8b?w=800&auto=format&fit=crop&q=60' },
      { id: 'ar13', author: '好创意画师', title: '人体结构透视：大透视张力构图下鱼眼畸变的修正', views: '4800', likes: '2.1万', image: 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=800&auto=format&fit=crop&q=60' },
  ...
  },
  {
    ...
    privatePosts: [
      { id: 'dc1', author: '好创意Popper', title: '【干货】Popping震感本质：肌肉收缩(Hit)与关节锁定的生物力学', views: '4500', likes: '1.2万', image: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=700&auto=format&fit=crop&q=60' },
      { id: 'dc2', author: '好创意B-Boy', title: '大风车(Windmill)滞空要领：腰部力量传递与地心引力对抗', views: '3800', likes: '9.5k', image: 'https://images.unsplash.com/photo-1535597401614-2d7442111100?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'dc5', author: '好创意Locker', title: 'Locking灵魂控制：如何将Twirl的离心力转化为干脆的Lock', views: '3100', likes: '8.2k', image: 'https://images.unsplash.com/photo-1729166240683-d571ede41f8b?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'dc8', author: '好创意B-Boy', title: 'Airflare(抛)的进阶瓶颈：起手姿势重心滞后导致的速度损耗', views: '2200', likes: '5.5k', image: 'https://images.unsplash.com/photo-1757580190832-1845c74de167?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'dc10', author: '好创意Popper', title: 'Roll与Ticking的区别：连续微收缩在不同BPM下的应用', views: '3600', likes: '9k', image: 'https://images.unsplash.com/photo-1535597401614-2d7442111100?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'dc14', author: '好创意Locker', title: 'Scooby Doo步伐的变种：如何在Battle中利用它改变空间', views: '2800', likes: '7.5k', image: 'https://plus.unsplash.com/premium_photo-1710064057043-d301e344e348?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'dc16', author: '好创意B-Boy', title: 'Toprock衔接Footwork的顺滑感：扫腿(Sweep)的滞空处理', views: '3900', likes: '1万', image: 'https://images.unsplash.com/photo-1757580190832-1845c74de167?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'dc20', author: '好创意Popper', title: 'Animatronics(定格动画)风格解析：极高频Stop的控制点', views: '6200', likes: '2.1万', image: 'https://images.unsplash.com/photo-1547153760-18fc86324498?w=700&auto=format&fit=crop&q=60' }
    ]
  },
  {
    id: 'transit',
    ...
    founder: '好创意 创办',
    heroTitle: '探索，记录，运转。\n尽在这一域。',
    lore: '本群起源于 2008 年好创意机电工程系的一间宿舍。',
    quiz: [
  ...
  },
  {
    ...
    privatePosts: [
      ...
      { id: 'fp4', author: '好创意扫街', title: '布列松的决定性瞬间：35mm焦段盲拍与超焦距陷阱对焦设置', views: '5100', likes: '1.9万', image: 'https://images.unsplash.com/photo-1516961642265-531546e84af2?w=800&auto=format&fit=crop&q=60' },
      ...
      { id: 'fp8', author: '好创意扫街', title: '区域曝光法(Zone System)实战：如何用点测光控制高光死白', views: '6500', likes: '2.5万', image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&auto=format&fit=crop&q=60' },
      ...
      { id: 'fp13', author: '好创意扫街', title: '大画幅8x10技术相机的沙姆定律(Scheimpflug)移轴操作详解', views: '4900', likes: '1.7万', image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&auto=format&fit=crop&q=60' },
      ...
      { id: 'fp18', author: '好创意扫街', title: '森山大道式的黑白硬核高反差街拍：Tri-X 400迫冲至1600样片', views: '8600', likes: '4.2万', image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&auto=format&fit=crop&q=60' },
  ...
  },
  {
    ...
    privatePosts: [
      ...
      { id: 'ig3', author: '好创意老猎人', title: '《黑神话悟空》动作受击反馈：卡肉感(Hitstop)的帧数延迟数据测算', views: '2.4万', likes: '8.8万', image: 'https://images.unsplash.com/photo-1580234811432-5202e524d77d?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'ig8', author: '好创意老猎人', title: '魂系地图箱庭理论：《黑魂1》传火祭祀场垂直捷径连通的三维坐标复刻', views: '1.8万', likes: '6.5万', image: 'https://images.unsplash.com/photo-1605901309584-818e25960b8f?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'ig13', author: '好创意老猎人', title: '《血源诅咒》怪兽动作AI：基于距离探测的攻击模组(MoveSet)触发权重', views: '1.3万', likes: '4.8万', image: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'ig18', author: '好创意老猎人', title: '《只狼》弹反系统(Deflect)帧数判定宽容度逐帧切片硬核分析', views: '2.1万', likes: '7.6万', image: 'https://plus.unsplash.com/premium_photo-1674374443275-20dae04975ac?w=700&auto=format&fit=crop&q=60' },
  ...
  },
  {
    ...
    privatePosts: [
      { id: 'cf1', author: '好创意萃取师', title: '浅烘埃塞的萃取率与水温关系：93℃与96℃下的TDS浓度实测图表', views: '4500', likes: '1.5万', image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'cf5', author: '好创意萃取师', title: 'WDT布粉针能否根除通道效应？通过无底手柄的高速摄像慢放分析', views: '5800', likes: '1.9万', image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'cf9', author: '好创意萃取师', title: '平刀磨豆机与锥刀磨豆机粒径分布(PSD)实测数据及对均匀萃取的意义', views: '7200', likes: '2.6万', image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'cf13', author: '好创意萃取师', title: '水质矿物质硬度(TDS)对咖啡弱酸风味析出的反渗透缓冲机制探究', views: '3600', likes: '1万', image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=700&auto=format&fit=crop&q=60' },
      ...
      { id: 'cf17', author: '好创意萃取师', title: '手冲四六法(4:6 Method)的数学验证：分段注水切割萃取不同风味层的科学论证', views: '8800', likes: '3.1万', image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=700&auto=format&fit=crop&q=60' },
...
const NOTIFICATIONS = [
  ...
  { id: 2, type: 'system', title: '认证通知', desc: '「好创意」现已成为986院校。', time: '1小时前', unread: true },
...
const DEFAULT_JOINED_CIRCLES = ['dance'];
const USER_INFO = MOCK_USERS[0];
const getMockTimestamp = () => Date.now();
...
const COLLAGE_IMAGES = [
  { src: CIRCLES[0].cover, pos: "top-[3%] left-[-1.25rem] w-[8.5rem] h-[11rem] -rotate-12" },
  { src: ACTIVITIES[0].cover, pos: "top-[6%] right-[1rem] w-[6.5rem] h-[8.25rem] rotate-6" },
  { src: CIRCLES[1].cover, pos: "top-[17%] left-[9.5rem] w-[6rem] h-[7.5rem] -rotate-3" },
  { src: ACTIVITIES[1].cover, pos: "top-[27%] left-[-1.75rem] w-[7.5rem] h-[7.5rem] rotate-12" },
  { src: CIRCLES[2].cover, pos: "top-[32%] right-[-1.5rem] w-[8.25rem] h-[10.5rem] -rotate-6" },
  { src: CIRCLES[3].cover, pos: "bottom-[28%] left-[1rem] w-[6.75rem] h-[8.75rem] -rotate-6" },
  { src: ACTIVITIES[3].cover, pos: "bottom-[24%] right-[1.2rem] w-[7rem] h-[7rem] rotate-12" },
  { src: CIRCLES[4].cover, pos: "bottom-[9%] left-[-1rem] w-[8rem] h-[10.5rem] rotate-6" },
  { src: ACTIVITIES[4].cover, pos: "bottom-[6%] right-[-1.25rem] w-[7.5rem] h-[9.5rem] -rotate-12" },
  { src: CIRCLES[5].cover, pos: "top-[52%] left-[8.5rem] w-[5.25rem] h-[6.75rem] rotate-3" },
];
...
export default function App() {
  ...
  const [loginForm, setLoginForm] = useState({ username: 'student', password: '123456' });
  const [loginError, setLoginError] = useState('');
  const [currentTab, setCurrentTab] = useState('home'); 
  const [activeCircle, setActiveCircle] = useState(null);
  const [joinedCircles, setJoinedCircles] = useState(DEFAULT_JOINED_CIRCLES); 
  ...
  const isAdmin = userInfo.type === ADMIN_ACCOUNT_TYPE;
  ...
  const handleLogin = (e) => {
    ...
    setAuthLoading(true);
    setLoginError('');
    const matchedUser = MOCK_USERS.find(user => user.username === username && user.password === password);

    setTimeout(() => { 
      setAuthLoading(false); 
      if (!matchedUser) {
        setLoginError('账号或密码不正确，请选择一个模拟身份');
        return;
      }

      setCurrentUser(matchedUser);
      setJoinedCircles(
        matchedUser.type === ADMIN_ACCOUNT_TYPE
          ? CIRCLES.map(circle => circle.id)
          : DEFAULT_JOINED_CIRCLES
      );
      setIsAuth(true); 
  ...
  const handleOpenQuiz = (circle) => {
    ...
    if (isAdmin) {
      handleJoinCircle(circle.id, '管理员端已直接进入圈层，无需验证');
      return;
    }

    // 👇 拦截：检查该圈子是否处于 30 分钟冷却期
    const lockoutTime = quizLockouts[circle.id];
    const now = getMockTimestamp();
    if (lockoutTime && now < lockoutTime) {
      const remainingMins = Math.ceil((lockoutTime - now) / 60000);
          ...
          <main className="auth-scroll relative z-10 h-full overflow-y-auto hide-scrollbar">
            <section className="min-h-full w-full overflow-hidden flex flex-col items-center justify-center bg-gradient-to-br from-[#F8F7FF] via-[#EAE1FF] to-[#FFFFFF] py-8">
              ...
              >
                ...
                <div className="w-full bg-white/82 backdrop-blur-2xl border border-white/80 rounded-[28px] p-5 shadow-[0_24px_80px_rgba(79,70,229,0.16)]">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#b7a8ff] to-[#c084fc] text-white flex items-center justify-center shadow-xl">
                      <ShieldCheck size={22} strokeWidth={2.5} />
                    </div>
                    <div className="text-left">
                      <h2 className="text-xl font-black tracking-tight text-[#1e1b4b]">登录同频</h2>
                      <p className="text-[11px] font-bold text-indigo-900/45">选择用户端或管理员端</p>
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {MOCK_USERS.map(user => {
                      const isAdminOption = user.type === ADMIN_ACCOUNT_TYPE;
                      const isSelected = loginForm.username === user.username;
                      const LoginIcon = isAdminOption ? ShieldCheck : User;
                      return (
                        <button
                          key={user.username}
                          type="button"
                          ...
                          className={`flex flex-col items-center justify-center gap-1.5 rounded-2xl px-3 py-3 text-xs font-black border transition-all active:scale-95 ${
                            isSelected
                              ? 'bg-[#1e1b4b] text-white border-[#1e1b4b] shadow-lg'
                              : 'bg-indigo-50/70 text-indigo-800 border-indigo-100 hover:bg-white'
                          }`}
                        >
                          <span className="flex items-center gap-1.5">
                            <LoginIcon size={14} strokeWidth={3} />
                            {isAdminOption ? '管理员端' : '用户端'}
                          </span>
                          <span className={`text-[10px] leading-none ${isSelected ? 'text-white/60' : 'text-indigo-400'}`}>
                            {isAdminOption ? '免验证进圈' : '验证后进圈'}
                          </span>
                        </button>
                      );
                    })}
                  ...
                  <form onSubmit={handleLogin} className="space-y-4">
                    <label className="block">
                      <span className="text-xs font-black text-indigo-400 uppercase tracking-widest">账号</span>
                      <div className="mt-2 flex items-center gap-3 bg-[#F8F7FF] border border-indigo-100 rounded-2xl px-4 focus-within:border-[#a78bfa] transition-colors">
                        ...
                        <input
                          ...
                          className="w-full bg-transparent py-3.5 outline-none text-sm font-black text-[#1e1b4b] placeholder:text-indigo-200"
                          placeholder="student"
                        />
                      </div>
                    </label>
                    ...
                    <label className="block">
                      <span className="text-xs font-black text-indigo-400 uppercase tracking-widest">密码</span>
                      <div className="mt-2 flex items-center gap-3 bg-[#F8F7FF] border border-indigo-100 rounded-2xl px-4 focus-within:border-[#a78bfa] transition-colors">
                        <Lock size={18} className="text-indigo-300 shrink-0" />
                        <input
                          type="password"
                    ...
                    {loginError && (
                      <div className="rounded-2xl bg-rose-50 border border-rose-100 px-4 py-3 text-sm font-bold text-rose-500 text-left">
                        {loginError}
                      </div>
                    )}
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-[#b7a8ff] to-[#c084fc] text-white font-black text-base rounded-2xl py-4 shadow-xl hover:scale-[1.01] active:scale-95 transition-all disabled:opacity-70 disabled:hover:scale-100 flex items-center justify-center gap-2"
                    >
                      {authLoading ? (
                        <>
                  ...
                  <div className="mt-4 rounded-2xl bg-indigo-50/70 px-4 py-3 text-xs font-bold text-indigo-400 leading-relaxed text-left">
                    用户端：student / 123456；管理员端：admin / admin123
                  </div>
                </div>
              </div>
  ...
  const renderSidebar = () => (
    <aside className="hidden flex-col w-64 h-screen fixed left-0 top-0 bg-white/50 backdrop-blur-3xl border-r border-white/60 p-8 z-40 text-left">
  ...
  const renderHeader = () => (
    <header className="sticky top-0 z-30 bg-white/50 backdrop-blur-2xl border-b border-white/50 px-6 py-4 flex justify-between items-center shadow-sm">
      ...
      <img src={userInfo.avatar} alt="Avatar" className="w-8 h-8 rounded-full object-cover shadow-sm border border-white" />
    </header>
  );

  const renderBottomNav = () => (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/70 backdrop-blur-3xl border-t border-white/60 pb-safe z-40 shadow-lg">
    ...
    <div className="pt-6 md:pt-10 px-4 md:px-6 max-w-6xl mx-auto animate-in fade-in pb-24 hide-scrollbar">
      ...
      <div className="flex justify-between items-center mb-8">
         ...
         <div className="w-10 h-10 rounded-full bg-white/80 p-0.5 shadow-sm border border-white">
            <img src={userInfo.avatar} className="w-full h-full rounded-full object-cover" alt="User"/>
         </div>
      </div>
    ...
    <div className="pt-6 md:pt-10 max-w-5xl mx-auto animate-in fade-in pb-24 hide-scrollbar">
      ...
      <div className="px-6 space-y-8 text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-12">
          {CIRCLES.map(circle => {
            const isJoined = isAdmin || joinedCircles.includes(circle.id);
            return (
    ...
    <div className="pt-6 md:pt-10 px-6 pb-24 max-w-4xl mx-auto animate-in fade-in hide-scrollbar">
      ...
      <GlassCard className="overflow-hidden p-0 border-0 shadow-xl">
        {notifications.map((msg) => (
          <div
            key={msg.id}
            onClick={() => setNotifications(prev => prev.map(item => item.id === msg.id ? { ...item, unread: false } : item))}
            className="flex gap-5 p-6 active:bg-white/40 hover:bg-white/20 transition-all cursor-pointer border-b border-white/40 last:border-0 relative"
          >
  ...
  const renderProfile = () => {
    ...
    if (currentTab === 'profile_comments') {
      ...
      const userComments = Object.entries(postComments).flatMap(([postId, comments]) => {
         ...
         return comments.filter(c => c.author === userInfo.name).map(c => ({
            ...c,
    ...
    // 获取用户评论总数
    const userCommentsCount = Object.values(postComments).flat().filter(c => c.author === userInfo.name).length;
      ...
      <div className="pt-6 md:pt-10 px-4 sm:px-6 pb-24 max-w-4xl mx-auto animate-in fade-in space-y-6 hide-scrollbar">
        ...
        <div className="bg-white rounded-[24px] p-6 sm:p-8 shadow-sm flex items-center gap-6">
          ...
          <div className="flex flex-col gap-1.5 justify-center">
            <h2 className="text-2xl sm:text-3xl font-black text-[#1e1b4b] tracking-tight">{userInfo.name}</h2>
            <p className="text-[11px] sm:text-xs font-bold text-indigo-300 tracking-widest">ID: {userInfo.id}</p>
            <div className="mt-1">
  ...
  const renderCircleDetail = () => {
    const isJoined = isAdmin || joinedCircles.includes(activeCircle.id);
                      ...
                      <div className="lg:col-span-7 group cursor-pointer" onClick={() => {
                        ...
                        if (topPost) setActivePost(topPost);
                         ...
                         <div className="flex items-center gap-3 text-xs font-bold text-indigo-900/60">
                            <img src={userInfo.avatar} className="w-6 h-6 rounded-full object-cover shadow-sm" alt="author" />
                              ...
                              <div key={`latest-${idx}`} className="flex gap-5 group cursor-pointer hover:bg-white/60 p-3 rounded-2xl transition-colors -mx-3" onClick={() => setActivePost(post)}>
                                 ...
                                 <div className="flex flex-col justify-center flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2 text-xs font-bold text-indigo-900/60">
                                      <img src={userInfo.avatar} className="w-5 h-5 rounded-full object-cover shadow-sm" alt="author" />
            ...
            {q.options.map((opt, idx) => (
              <button key={idx} onClick={() => { 
                if (idx === q.answer) { 
                  ...
                  setQuizLockouts(prev => ({ ...prev, [activeCircle.id]: getMockTimestamp() + 30 * 60 * 1000 }));
                  setQuizStep(0);
                  setShowQuiz(false);
        ...
        <article className="max-w-4xl mx-auto w-full px-6 pt-12 pb-24">
           ...
           <div className="max-w-2xl mx-auto mt-16 bg-white border border-[#111]/10 p-6 md:p-10 shadow-sm">
              ...
              <form onSubmit={handleCommentSubmit} className="flex gap-3 relative">
                 <img src={userInfo.avatar} className="w-10 h-10 rounded-full object-cover shrink-0 hidden sm:block" alt=""/>
  ...
  return (
    <div className="min-h-screen bg-[#dfe2ee] flex items-center justify-center md:py-6">
      <div className="mobile-shell bg-gradient-to-br from-[#F8F7FF] via-[#EAE1FF] to-[#FFFFFF] font-sans flex text-indigo-950 selection:bg-[#c084fc]/20 overflow-hidden">
        {renderSidebar()}
        <main className="flex-1 flex flex-col h-full relative overflow-hidden">
          {renderHeader()}
          {toast && (
            <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[120] bg-white/95 backdrop-blur-2xl border border-[#a78bfa]/20 px-6 py-4 rounded-3xl text-sm font-black flex items-center shadow-xl animate-in slide-in-from-top-4 border-b-4 border-b-[#a78bfa] max-w-[calc(100%-2rem)]">
              <CheckCircle2 size={20} strokeWidth={3} className="text-[#a78bfa] mr-3 shrink-0" /> {toast}
            </div>
          )}
